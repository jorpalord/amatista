 ...
 * por API key. Los runtimes CLI (claude-cli, codex-subscription,
 * gemini-cli por suscripcion) requieren spawnear un binario externo y
 * quedan fuera de esta categoria.
 *
